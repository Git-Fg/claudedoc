---
number: 03
title: Hooks Specific
audience: self-maintenance
related: [00, 01, 02, 04, 05, 06]
...
| MCP Servers | → [06-mcp.md](06-mcp.md) | comprehensive MCP documentation |
...
cat <<EOF
{
  "hookSpecificOutput": {
    "hookEventName": "SessionStart",
    "additionalContext": "${injected_discipline}"
  }
}
EOF
...
> **Comprehensive Documentation**: See [06-mcp.md](./06-mcp.md) for complete MCP documentation including:
> - MCP protocol overview and architecture
> - Installing MCP servers (HTTP, stdio, SSE)
> - MCP installation scopes (local, project, user)
> - Tool naming conventions and patterns
...
| Topic | Location in 06-mcp.md |
|-------|----------------------|
| What is MCP? | Overview section |
| Installing servers | "Installing MCP Servers" section |
| HTTP transport | Option 1: Add a remote HTTP server |
| Stdio transport | Option 3: Add a local stdio server |
| Tool naming | "Tool Naming Convention" section |
