...
fetchTime: 2026-02-04T07:31:52.145Z
---
...
#### [Windows](#windows)
Recommended: Use WSL
For the best experience on Windows, we recommend using [Windows Subsystem for Linux (WSL)](https://opencode.ai/docs/windows-wsl). It provides better performance and full compatibility with OpenCode’s features.
-   **Using Chocolatey**
    Terminal window
    ```
